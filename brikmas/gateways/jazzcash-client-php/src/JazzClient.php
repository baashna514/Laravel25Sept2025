...
class JazzClient
{
    ...
    public function __construct($config = [])
    {
        ...
        $this->apiBaseUrl = $config['apiBaseUrl'] ?? getenv('JAZZCASH_API_BASE_URL');
        $this->merchantId = $config['merchantId'] ?? getenv('JAZZCASH_MERCHANT_ID');
        $this->password = $config['password'] ?? getenv('JAZZCASH_PASSWORD');
        $this->sharedSecret = $config['salt'] ?? getenv('JAZZCASH_SALT');
