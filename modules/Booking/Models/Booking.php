...
class Booking extends BaseModel
{
    ...
    if(!empty($items))
    {
        foreach ($items as $item)
        {
            ...
            // Fix: only check by course_id and user_id to avoid duplicates
            $c2u = Course2User::where('course_id', $itemObj->object_id)
            ...
            if(!$c2u){
                ...
                // Exists, update order_id if needed
                if($c2u->order_id != $this->id){
