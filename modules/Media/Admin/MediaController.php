...
class MediaController extends AdminController
{
     ...
     * @throws \Exception
     */
    public function validateFile($file, $group = "default")
{
    // Force default group to allow all types
    $group = 'default';

    $allowedExts = [
        'jpg', 'jpeg', 'bmp', 'png', 'gif', 'zip', 'rar', 'pdf', 'xls', 'xlsx', 'txt',
        'doc', 'docx', 'ppt', 'pptx', 'webm', 'mp4', 'mp3', 'flv', 'vob', 'avi', 'mov', 'wmv', 'svg'
    ];
    ...
    public function getLists(Request $request)
    {
        ...
        $file_type = $request->input('file_type', 'file');
        ...
        switch ($file_type) {
                    case "image":
                        ...
                        break;
                    case "video":
                        // Allow video files and PDFs for supplementary materials
                        $ext = [
                            'mp4','ogv','webm','webvtt','pdf','ppt','pptx'
                        ];
                        $model->whereIn('file_extension', $ext);
                        $model2->whereIn('file_extension',$ext);
                        break;
                    ...
                    case "scorm":
                        ...
                        break;
                    default:
                        // For any other type, allow all file types that are in the default validation group
                        $ext = [
                            'jpg', 'jpeg', 'bmp', 'png', 'gif', 'zip', 'rar', 'pdf', 'xls', 'xlsx', 'txt',
                            'doc', 'docx', 'ppt', 'pptx', 'webm', 'mp4', 'mp3', 'flv', 'vob', 'avi', 'mov', 'wmv', 'svg'
                        ];
